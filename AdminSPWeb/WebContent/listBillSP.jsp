...
<div class="navbar navbar-inverse navbar-static-top">
    <div class="navbar-inner">
        ...
        <div class="pull-right">
       		<a class="btn btn-inverse" data-loading-text="Loading..." href="SPController?type=Bill&action=refresh"> <i class="icon-refresh icon-white"></i> </a>
...
<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
	...
	<tbody>
        ...
        <td style="text-align:center;">${sp.hasCache() ? '<i class="icon-ok-sign icon-large"></i>' : '<i class="icon-remove-sign icon-large"></i>'}</td>
